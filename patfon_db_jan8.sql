...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2018 at 10:50 AM
...
CREATE TABLE `class_fees` (
  ...
  `c_uniform` int(11) DEFAULT '0',
  `uniform` int(11) DEFAULT '0',
  `sp_wear` int(11) DEFAULT '0',
  `ca` int(11) DEFAULT '0',
  `category` int(11) NOT NULL,
  `school` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `class_fees` (`id`, `fee`, `bus`, `pullover`, `party`, `c_uniform`, `uniform`, `sp_wear`, `ca`, `category`, `school`) VALUES
(1, 15000, 4000, 3000, 1500, 2000, 1200, 2000, 3000, 7, 1),
(2, 15000, 4000, 3000, 1500, 2000, 1200, 2000, 3000, 8, 1),
(3, 20000, 4000, 3000, 1500, 2000, 1200, 2000, 3000, 9, 1),
(4, 23000, 4000, 3000, 1500, 2000, 1200, 2000, 3000, 10, 1),
(5, 26000, 4000, 3000, 1500, 2000, 1200, 2000, 3000, 11, 1),
(6, 24400, 4000, 3000, 1500, 2000, 1200, 2000, 3000, 12, 1),
(7, 12500, 0, 0, 0, 0, 0, 0, 0, 7, 2),
(8, 15000, 0, 0, 0, 0, 0, 0, 0, 8, 2),
(9, 16000, 0, 0, 0, 0, 0, 0, 0, 9, 2),
(10, 23000, 0, 0, 0, 0, 0, 0, 0, 10, 2),
(11, 26000, 0, 0, 0, 0, 0, 0, 0, 11, 2),
(12, 24400, 0, 0, 0, 0, 0, 0, 0, 12, 2),
(13, 12500, 0, 0, 0, 0, 0, 0, 0, 7, 3),
(14, 15000, 0, 0, 0, 0, 0, 0, 0, 8, 3),
(15, 16000, 0, 0, 0, 0, 0, 0, 0, 9, 3),
(16, 23000, 0, 0, 0, 0, 0, 0, 0, 10, 3),
(17, 26000, 0, 0, 0, 0, 0, 0, 0, 11, 3),
(18, 24400, 0, 0, 0, 0, 0, 0, 0, 12, 3);
...
CREATE TABLE `student_fees` (
  ...
  `school` int(11) NOT NULL,
  `modepay` varchar(100) DEFAULT NULL,
  `modebank` varchar(100) NOT NULL,
...
INSERT INTO `student_fees` (`id`, `stu_id`, `term`, `year_`, `amount`, `type_`, `bal`, `extra`, `user_collect`, `school`, `modepay`, `modebank`, `discount`, `date_pay`) VALUES
(1, 28, 1, 2018, 15000, 99, 0, 0, 1, 1, 'bank', 'boss bank', 0, '2018-01-08'),
(2, 28, 1, 2018, 0, 100, 0, 0, 1, 1, 'bank', 'boss bank', 0, '2018-01-08'),
(3, 28, 1, 2018, 4000, 2, 0, 0, 1, 1, 'bank', 'boss bank', 0, '2018-01-08'),
(4, 28, 1, 2018, 3000, 5, 0, 0, 1, 1, 'bank', 'boss bank', 0, '2018-01-08'),
(5, 28, 1, 2018, 0, 7, 0, 0, 1, 1, 'bank', 'boss bank', 0, '2018-01-08'),
(6, 28, 1, 2018, 2000, 3, 0, 0, 1, 1, 'bank', 'boss bank', 0, '2018-01-08'),
(7, 28, 1, 2018, 0, 4, 0, 0, 1, 1, 'bank', 'boss bank', 0, '2018-01-08'),
(8, 28, 1, 2018, 3000, 6, 0, 0, 1, 1, 'bank', 'boss bank', 0, '2018-01-08'),
(9, 19, 1, 2018, 15000, 99, 0, 0, 1, 1, 'bank', 'shsshs bank', 0, '2018-01-08'),
(10, 19, 1, 2018, 0, 100, 0, 0, 1, 1, 'bank', 'shsshs bank', 0, '2018-01-08'),
(11, 19, 1, 2018, 4000, 2, 0, 0, 1, 1, 'bank', 'shsshs bank', 0, '2018-01-08'),
(12, 19, 1, 2018, 3000, 5, 0, 0, 1, 1, 'bank', 'shsshs bank', 0, '2018-01-08'),
(13, 19, 1, 2018, 0, 7, 0, 0, 1, 1, 'bank', 'shsshs bank', 0, '2018-01-08'),
(14, 19, 1, 2018, 2000, 3, 0, 0, 1, 1, 'bank', 'shsshs bank', 0, '2018-01-08'),
(15, 19, 1, 2018, 0, 4, 0, 0, 1, 1, 'bank', 'shsshs bank', 0, '2018-01-08'),
(16, 19, 1, 2018, 0, 6, 0, 0, 1, 1, 'bank', 'shsshs bank', 0, '2018-01-08');

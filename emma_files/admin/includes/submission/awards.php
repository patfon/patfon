	...
	<!-- box / title -->
			...
			<div id="ctl00_ContentPlaceHolder1_BoxMessage_Info_Panel_SuccessMessage">
	              <div id="message-success" class="message message-success">
                       ...
                       <img src="../../images/notice1.png" alt="warning" height="32" alt="Warning">
					        ...
					        <h6>Examples</h6>
							<span id="examples">Best Poster Presentation award in National Symposium on biodiversity, cell and molecular biology held at Yale University, USA, on Feb. 26-27, 2008.</span>
				            </div>
							</div>
		   ...
		   <!-- end box / title -->
			...
			<div id="form2" style="padding-left:16px;padding-right:16px;">
				<form id="profilefrom2" action="<?php echo $myurl.'controller/user/awards.php'; ?>" method="post">
					...
					<table id="author2" width="100%">
						...
						<tr style="background:#999;">
							<td style="width:200px;text-align:center;font-weight: bold;">
								No.</td>
							<td id="detailTitle" style="text-align:center;font-weight: bold;">Honors and Awards</td>
						</tr>
						
							<tr id="1">
								<td style="width:200px;" align="center">1</td>
								<td align="center" id="detailTitle">
								<input type="text" class="form2input" name="honor" id="ProfileContent0" maxlength="1000" required> 

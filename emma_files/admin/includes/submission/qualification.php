...
<div id="box-tabs" class="box">
	<!-- box / title -->
			...
			<div id="ctl00_ContentPlaceHolder1_BoxMessage_Info_Panel_SuccessMessage">
	              <div id="message-success" class="message message-success">
                        ...
                        <img src="../../images/notice1.png" alt="warning" height="32" alt="Warning" height="32">
					        ...
					        <h6>Examples</h6>
							<span id="examples">From: 09/2005 &nbsp;&nbsp;To: 10/2010<br>Education Qualification: Doctorate<br>Country: USA</span>
				            </div>
							</div>
		   ...
		   <form id="form1" name="form1" action="<?php echo $myurl.'controller/user/qualific.php'; ?>" method="post">
					<div class="fields" id="1" style="border:1px solid #326395;margin-top: 2px;">
							<div class="field">
								...
								<div class="input" style="width:70%">
									<input type="date" name="from" id="FromDateTime0" class="small" maxlength="30" required>
								</div>
							</div>
							<div class="field">
								<div class="label" style="width:10%">
								...
								<div class="input" style="width:70%">
									<input type="date" name="to" id="EndDateTime0" class="small" maxlength="30" required>
								</div>
							</div>
							...
							<div class="field">
								<div class="label">
									<label for="input-medium" id="qualifyTitle">Education Qualification</label>
								</div>
								<div class="input">
								<input type="text" style="border: none;color:red;" value=" Education Qualification should start with uppercase." class="large" disabled="disabled">
									<input type="text" name="edu" id="Position0" class="medium" maxlength="1000" required>
								</div>
							</div>
							<div class="field">
								<div class="label">
									<label for="input-large" id="positionTitle">Country</label>
								</div>
								<div class="input">
								<input type="text" style="border: none;color:red;" value=" Country should start with uppercase." class="large" disabled="disabled">
									<input type="text" name="country" id="ProfileContent1" class="medium" maxlength="1000" required>
                                </div>
